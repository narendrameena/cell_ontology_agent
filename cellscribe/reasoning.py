...
Full classification against the whole Cell Ontology needs a CL import module; here
we reason over the self-contained draft (genus + differentia), which verifies the
axiom is satisfiable and that the term subsumes under its asserted genus.
"""
